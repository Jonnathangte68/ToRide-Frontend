...
import { selectMenuOption, setUsername } from "../../features/Demo/demoSlice";
    ...
    return (
        <NavMenu>
          ...
          <MenuOptionsContainer>
            <br/>
            <OptionItemMiddle className={css`${optionSelected === 1 && "border-right: 3px solid "+COLORS.ORANGE}`}>
              <img
                src={optionSelected === 1 ? "../assets/img/messages-menu-item.png" : "../assets/img/messages-menu-item-1-unselected.png" }
                alt="Not Found"
                className="icon-menu-icon-1"
                onClick={() => navigate("/owner/messages", { replace: false })}
              />
            </OptionItemMiddle>
            <OptionItemMiddle className={css`${optionSelected === 2 && "border-right: 3px solid "+COLORS.ORANGE}`}>
              <img
                ...
                alt="Not Found"
                className="icon-menu-icon-1"
                onClick={() => navigate("/owner/students", { replace: false })}
              />
            </OptionItemMiddle>
            <OptionItemMiddle className={css`${optionSelected === 3 && "border-right: 3px solid "+COLORS.ORANGE}`}>
              <img
                ...
                alt="Not Found"
                className="icon-menu-icon-1"
                onClick={() => navigate("/owner/staff", { replace: false })}
              />
            </OptionItemMiddle>
            <OptionItemMiddle className={css`${optionSelected === 4 && "border-right: 3px solid "+COLORS.ORANGE}`}>
              <img
                src={optionSelected === 4 ?  "../assets/img/vehicle-menu-item-option-selected.png" : "../assets/img/vehicle-menu-item-option-unselected.png" }
                alt="Not Found"
                className="icon-menu-icon-1"
                onClick={() => navigate("/owner/vehicles", { replace: false })}
              />
            </OptionItemMiddle>
            <OptionItemMiddle className={css`${optionSelected === 5 && "border-right: 3px solid "+COLORS.ORANGE}`}>
              <img
                ...
                alt="Not Found"
                className="icon-menu-icon-1"
                onClick={() => navigate("/owner/classes", { replace: false })}
              />
            </OptionItemMiddle>
            <OptionItemMiddle className={css`${optionSelected === 6 && "border-right: 3px solid "+COLORS.ORANGE}`}>
              <img
                ...
                alt="option location"
                className="icon-menu-icon-1"
                onClick={() => navigate("/owner/locations", { replace: false })}
              />
            </OptionItemMiddle>
            <OptionItemMiddle className={css`${optionSelected === 7 && "border-right: 3px solid "+COLORS.ORANGE}`}>
              <img
                src={optionSelected === 7 ? "../assets/img/certificate-menu-item-option-selected.png" : "../assets/img/certificate-menu-item-option-unselected.png" }
                alt="Not Found"
                className="icon-menu-icon-1"
                onClick={() => navigate("/owner/certificates", { replace: false })}
              />
            </OptionItemMiddle>
            <OptionItemMiddle className={css`${optionSelected === 8 && "border-right: 3px solid "+COLORS.ORANGE}`}>
              <img
                ...
                alt="Not Found"
                className="icon-menu-icon-1"
                onClick={() => navigate("/owner/transactions", { replace: false })}
              />
            </OptionItemMiddle>
            <OptionItemMiddle className={css`${optionSelected === 9 && "border-right: 3px solid "+COLORS.ORANGE}`}>
              <img
                ...
                alt="Not Found"
                className="fi-box"
                onClick={() => navigate("/owner/simulators", { replace: false })}
              />
            </OptionItemMiddle>
          </MenuOptionsContainer>
          <SettingsButton />
