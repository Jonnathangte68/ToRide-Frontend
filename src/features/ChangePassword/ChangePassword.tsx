  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!!form) {
      ...
      if (password !== password2) {
        props?.onDisplayError("Passwords doesn't match.");
        return;
      }
    ...
    <div className="sign-in-screen">
      ...
      <div className="container-sign-in">
        ...
        <div className="flex-col-hcenter-sign-in">
          <h1 className="txt-4101-sign-in">Change Your Password</h1>
          <p className="txt-582-sign-in">Enter your details to proceed further</p>
          <form onSubmit={handleSubmit}>
            ...
            <div className="space-input-from-form-sign-in">
              <InputPassword
                ...
                name="password2"
                value={password2}
                onChange={(password: string) => setPassword2(password)}
              />
            </div>
            <div className="space-input-from-form-sign-in">
              <InputButton
