...
import { fetchStudent, getStats } from "../../Demo/demoSlice";
...
export default function DashboardScreen() {
  ...
  const [tableOptionSelected, setTableOptionSelected] = useState(1);
  ...
  const [transactionList,] = useState([
      {
        name: "sd",
        size: "gsa",
        instructor_id: "gadgas",
        start_date: "gajkdbgjksbd",
        select_option: <ThreeDots onClick={handleClickRow}/>
      },
      {
        name: "sd",
        size: "gsa",
  ...
  const columns = [{
    ...
    headerStyle: (colum, colIndex) => {
        return { width: '20vh', textAlign: 'center' };
    }
  }, {
    ...
    dataField: 'select_option',
    text: "",
    headerAlign: 'center',
    headerStyle: (colum, colIndex) => {
        return { width: '6vh', textAlign: 'center' };
    }
  }];
              ...
              <DashboardBody>
                ...
                <DashboardContent>
                  ...
                  <div className="_-4 flex-row" style={{ marginRight: "2%" }}>
                    <div className={"calender bg-gray-500 "+css`margin-right: 8px; box-sizing: border-box; margin-left: .83vh; width: 124.5vh; height: 100%; border: 1px solid ${COLORS.GRAY_BORDER_TABLE}; padding: 1.45vh; border-radius: 15px;`}>
                      <ul className={css`display:flex;list-style: none; padding-top: 1.35vh; padding-bottom: 1.35vh;`}>
                          <li className={css`width: 15vh;`}>
                              <p className={"txt-559 flex-hcenter "+css`font-size: .88rem !important; display:inline; width: 2vh;  padding-left: 0.44vh;padding-right: 0.44vh; ${tableOptionSelected === 1 && "color: white !important; padding: 2vh; border-radius: 20px; background-color:"+COLORS.MORE_RED_BUTTON }`} onClick={() => setTableOptionSelected(1)}>All</p>
                          </li>
                          <li className={css`width: 15vh;`}>
                              <p className={"txt-559 flex-hcenter "+css`font-size: .88rem !important; display:inline; width: 2vh;padding-left: 0.44vh;padding-right: 0.44vh; ${tableOptionSelected === 2 && "color: white !important; padding: 2vh; border-radius: 20px; background-color:"+COLORS.MORE_RED_BUTTON }`} onClick={() => setTableOptionSelected(2)}>Schools</p>
                          </li>
                          <li className={css`width: 15vh;`}>
                              <p className={"txt-559 flex-hcenter "+css`font-size: .88rem !important; display:inline; width: 2vh;padding-left: 0.44vh;padding-right: 0.44vh; ${tableOptionSelected === 3 && "color: white !important; padding: 2vh; border-radius: 20px; background-color:"+COLORS.MORE_RED_BUTTON }`} onClick={() => setTableOptionSelected(3)}>Classes</p>
                          </li>
                          <li className={css`width: 15vh;`}>
                              <p className={"txt-559 flex-hcenter "+css`font-size: .88rem !important; display:inline; width: 2vh;padding-left: 0.44vh;padding-right: 0.44vh; ${tableOptionSelected === 4 && "color: white !important; padding: 2vh; border-radius: 20px; background-color:"+COLORS.MORE_RED_BUTTON }`} onClick={() => setTableOptionSelected(4)}>Locations</p>
                          </li>
                      </ul>


                      {/* TABLE TO LOG THE EVENTS DETAILS. */}
                          ...
                          >
                          {
                              (props: any) => (
                                  <>
                                      ...
                                      <BootstrapTable
                                          { ...props.baseProps }
                                          classes={ css`background-color: white; min-height: 50vh; max-height: 50vh` }
                                      />
                                      </TableScreen>
                                  </>
                              )
